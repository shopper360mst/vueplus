...
<template>
  <div class="min-h-screen bg-tertiary">
    <!-- Carousel Section -->
    <section class="relative w-full h-[300px] md:h-[500px] overflow-hidden bg-black">
      <div 
      ...
      >
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center text-white px-4">
          <h2 class="text-3xl md:text-5xl font-black mb-4 text-center">{{ t('promotions.banner_title') }}</h2>
    ...
    <!-- Buttons Section -->
    <section class="w-full flex flex-col items-center py-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto justify-items-center">
          <button
            ...
            class="btn-primary-alt w-full min-h-[100px] rounded-3xl font-black uppercase tracking-wider text-center"
