...
#[AsCommand(name: 'app:create-long')]
class CreateLong extends Command
{
    //protected static $defaultName = 'app:create-long';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $_DEFAULTMENU = [
            ...
            //Turn on for WINNER VERSION
            array(
                'label' => "Winners",
                "url" => $PROXY_LINK."en/winnerlist",
                "menu_code" => "",
                "submenu_code" => "",
                "weight" => 4,
                "menu_index" => 0,
        ...
        $output->writeln([
            '',
            'Menu and Campaign Config generated. Make sure in HomeController switch on start and services.yaml to full_version = true. Last but not least welcome to long mode.'
        ]
        );
        return 0;
    }
